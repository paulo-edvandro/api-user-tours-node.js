      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alerts.showAlert)('success', 'Logado com sucesso!');
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.error('Erro no logout:', _t2.response || _t2); // log completo
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Registrado com sucesso!');
            window.setTimeout(function () {
              location.assign("/check-email?email=".concat(res.data.email));
            }, 800);
          }
          _context.n = 3;
          break;
...
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"leafletMap.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc, i) {
    ...
    var day = typeof loc.day !== 'undefined' ? loc.day : i + 1;
    var marker = L.marker([lat, lng], {
      icon: markerIcon
    }).addTo(map).bindPopup("<p>Day ".concat(day, ": ").concat(loc.description, "</p>"), {
      autoClose: false,
      closeOnClick: false
    });
    markers.push(marker);
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            //   location.assign('/');
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " atualizado com sucesso!"));
          }
          _context.n = 3;
          break;
        case 2:
...
var stripe = Stripe('pk_test_51SYb7ID3AlBEDttQba7YL0s6ZzcMPsKPOdfdLmOJfdsEv4ItYwqEuGBr8oRHqOR2I5x4W8Z2BGcv1tnotksabhWX00Bw4nHAqu');
...
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"resendEmail.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var resendEmail = exports.resendEmail = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Email reenviado com sucesso!');
          }
          _context.n = 3;
          break;
        case 2:
  ...
  return function resendEmail(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Arquivo: public/js/forgotPassword.js
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Token de redefinição enviado para o seu e-mail!');
          }
          _context.n = 3;
          break;
        case 2:
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(password, passwordConfirm, token) {
    var res, _err$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Senha redefinida com sucesso! Redirecionando para o login...');
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alerts.showAlert)('error', ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Ocorreu um erro ao redefinir a senha.');
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
var _resendEmail = require("./resendEmail");
...
var resendEmailForm = document.querySelector('.form--resend-email');
...
if (signupForm) {
  signupForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(e) {
      ...
      var username, email, password, passwordConfirm, name, role, photo, form;
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          case 0:
            ...
            name = ((_document$getElementB = document.getElementById('signup-name')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.value) || '';
            role = ((_document$getElementB2 = document.getElementById('signup-role')) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.value) || undefined;
            photo = (_document$getElementB3 = document.getElementById('signup-photo')) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.files[0]; // FormData para suportar imagem
            form = new FormData();
...
if (resendEmailForm) {
  resendEmailForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          case 0:
            ...
            _context4.n = 1;
            return (0, _resendEmail.resendEmail)(email);
          case 1:
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          case 0:
            ...
            _context5.n = 1;
            return (0, _forgotPassword.forgotPassword)(email);
          case 1:
            document.querySelector('.btn--forgot-password').textContent = 'Enviar link de redefinição';
          case 2:
      ...
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.n) {
          case 0:
            ...
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password-confirm').value;
            document.querySelector('.btn--reset-password').textContent = 'Redefinindo...';
            _context6.n = 1;
            return (0, _resetPassword.resetPassword)(password, passwordConfirm, token);
          case 1:
            document.querySelector('.btn--reset-password').textContent = 'Redefinir Senha';
          case 2:
