...
function escolherColecao(model, Model) {
  //1 LER O ARQUIVO JSON CONTENDO OS DOCUMENTOS TESTE
  const arquivoJson = JSON.parse(
    fs.readFileSync(`${__dirname}/${model}-simple.json`, 'utf-8'),
  );
